...
| [`use-xnoop`](.claude/skills/use-xnoop/SKILL.md) | Uses Xn00p LITE to analyze segmented offline XNU kernel-memory dumps: resolve and type addresses, inspect zones/processes/tasks and kernel subsystems, search memory and references, and correlate findings cautiously with a local XNU source checkout. |
